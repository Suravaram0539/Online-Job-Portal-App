...
export class AuthenticationService {
  ...
  constructor(private httpClient: HttpClient, private router: Router) {
    this.registerEndPoint = 'http://ec2-15-206-157-42.ap-south-1.compute.amazonaws.com:8080/auth/register';
      
    this.loginendpoint = 'http://ec2-15-206-157-42.ap-south-1.compute.amazonaws.com:8080/auth/login';

    this.changePasswordEndPoint='http://ec2-15-206-157-42.ap-south-1.compute.amazonaws.com:8080/auth/changePassword';

    this.updateProfileEndPoint="http://ec2-15-206-157-42.ap-south-1.compute.amazonaws.com:8080/auth/update"

    this.getProfileEndPoint="http://ec2-15-206-157-42.ap-south-1.compute.amazonaws.com:8080/auth/get";

    this.wishlistendpoint= "http://ec2-15-206-157-42.ap-south-1.compute.amazonaws.com:8080/wishlist";
  }
